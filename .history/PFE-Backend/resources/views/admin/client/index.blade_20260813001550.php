            ...
            <tbody>
                @forelse ($clients as $client)
                    <tr>
                        ...
                        <span class="admin-lengend admin-lengend-item"><span class="pastille-verte"></span>
                        @elseif ($client->account_status === 'pending')
                        <span class="admin-lengend admin-lengend-item"><span class="pastille-jaune"></span>
                        @else
                        <span class="admin-lengend admin-lengend-item"><span class="pastille-rouge"></span>
                        @endif
                        </td>
                        <td>
                        ...
                        <td>
                            <div class="flex items-center gap-3">
                                <a href="{{ route('admin.client.show', $client->id) }}" class="admin-action admin-action-blue" title="Voir"><i class="fa-solid fa-eye"></i></a>
