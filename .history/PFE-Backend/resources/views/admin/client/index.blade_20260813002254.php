...
<!-- Lien CDN indispensable pour afficher les icônes Font Awesome partout sur la page -->
                    ...
                    <tr>
                        ...
                        <td>
                            @if ($client->account_status === 'active')
                                <span class="admin-lengend admin-lengend-item"><span class="pastille-verte"></span></span>
                            @elseif ($client->account_status === 'pending')
                                <span class="admin-lengend admin-lengend-item"><span class="pastille-jaune"></span></span>
                            @else
                                <span class="admin-lengend admin-lengend-item"><span class="pastille-rouge"></span></span>
                            @endif
                        </td>
                        <td>
