                        ...
                        <td>
                            ...
                            <div class="flex items-center gap-3" style="display: flex; gap: 10px; align-items: center; white-space: nowrap;">
                                ...
                                <form method="POST" action="{{ route('admin.client.destroy', $client->id) }}"
                                      ...
                                      data-confirm-text="Le compte et toutes ses réponses au questionnaire seront définitivement supprimés. Cette action est irréversible. vous pouver modifier le compte e"
