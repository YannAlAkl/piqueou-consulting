        ...
        <form action="/register" method="POST">
            ...
            <div class="form-group">
                ...
                <div class="form-group full-width checkbox-group">
                    ...
                    <input type="checkbox" id="wants_newsletter" name="wants_newsletter" value="1" {{  old('wants_newsletter') == 1  ? 'checked':'' }}>
                    <label for="wants_newsletter">S'abonner à la newsletter</label>
                </div>

                <!-- newsletter_category (NULL) -->
                <div class="form-group full-width" id ="newsletter_category_container" style="display:">
