    ...
    <div class="form-container">
        ...
        <form action="/register" method="POST">
            ...
            <div class="form-group">
                ...
                <div x-data="{ wantsNewsletter: false }">
    <div class="form-group full-width checkbox-group">
        <input type="hidden" name="wants_newsletter" value="0">
        <input type="checkbox" id="wants_newsletter" name="wants_newsletter" value="1" x-model="wantsNewsletter">
        <label for="wants_newsletter">S'abonner à la newsletter</label>
    </div>

    <!-- C'est ce x-if qui fait exactement ce que vous demandez -->
    <template x-if="wantsNewsletter">
