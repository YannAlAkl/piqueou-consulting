...
@section('subtitle', 'Répondez au questionnaire avant l\'analyse de nos experts.')

@section('content')

    @forelse ($questionnaires as $questionnaire)
        @php $soumission = $mesSoumissions->get($questionnaire->id); @endphp
        ...
        <div class="client-card">
            ...
            <a href="{{ route('client.questionnaire.show', $questionnaire->id) }}" class="client-btn client-btn-blue mt-4">
                @if (! $soumission)
                    Commencer
                @elseif (in_array($soumission->status, ['not_started', 'in_progress']))
                    Continuer
