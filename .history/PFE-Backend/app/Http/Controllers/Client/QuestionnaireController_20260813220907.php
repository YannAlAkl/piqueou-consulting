...
class QuestionnaireController extends Controller
{
    ...
    public function submit(Request $request, int $id)
    {
        ...
        $soumission = UserQuestionnaire::firstOrCreate(
            [
                'user_id' => auth::id(),vscode-file://vscode-app/c:/Users/DELL/AppData/Local/Programs/Microsoft%20VS%20Code/df53daabb1/resources/app/out/vs/code/electron-browser/workbench/workbench.html
                'questionnaire_id' => $questionnaire->id,
            ],
            [
                'status' => 'in_progress',
